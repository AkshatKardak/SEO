    ...
    return (
        <div className="min-h-screen pt-16 md:pt-24 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                {/* Error */}
                {error && (
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-danger/10 border border-danger/20 text-danger text-sm mb-6">
                        <AlertCircle size={16} className="shrink-0" />
                        {error}
                        <button onClick={fetchAnalyses} className="ml-auto underline text-xs hover:no-underline">
                            Retry
                        </button>
                    </div>
                )}
